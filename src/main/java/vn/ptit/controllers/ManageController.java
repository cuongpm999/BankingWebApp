...
public class ManageController {
	...
	public String viewHomeManage(Model model) {
		int countTransaction = rest.getForObject(domainServices+"/rest/api/statistics/count-trasaction", Integer.class);
		int countCustomer = rest.getForObject(domainServices+"/rest/api/statistics/count-customer", Integer.class);
		int countBankAccount = rest.getForObject(domainServices+"/rest/api/statistics/count-bank-account", Integer.class);
